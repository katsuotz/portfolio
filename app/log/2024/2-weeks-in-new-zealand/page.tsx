        ...
        <div className="container max-w-[900px] flex flex-col gap-4">
          ...
          <section>
            <div className="flex justify-center mb-4">
              <div>
                <iframe width="315" height="560" src="https://www.youtube.com/embed/iv6lTzOAGEs?si=0PKW9G_-6dMCULxp"
                        title="YouTube video player" frameBorder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                        referrerPolicy="strict-origin-when-cross-origin"
                        allowFullScreen></iframe>
                <p className="text-center mt-2">Mt. Cook Skydiving (13.000 ft)</p>
              </div>
            </div>
          ...
          <section>
            <div className="flex justify-center mb-8">
              <iframe width="600" height="300" src="https://www.youtube.com/embed/R5MXCXK6RSQ?si=z8HF5ynee3Eq4Dm7"
          ...
          <div className="flex justify-center">
            <div>
              <iframe width="315" height="560" src="https://www.youtube.com/embed/kWu_dpsIgPs?si=vlVYRR-yXD3rzqtd"
                      title="YouTube video player" frameBorder="0"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                      referrerPolicy="strict-origin-when-cross-origin"
                      allowFullScreen></iframe>
              <p className="text-center mt-2">Penguin Crossing the Road at Oamaru</p>
            </div>
          </div>
        </div>
      </div>
