  ...
  return (
    <GlobalStateProvider>
      ...
      <section className="relative flex flex-col justify-center items-center lg:pt-12 pt-12 lg:pb-20 pb-12">
        <h3 className="text-3xl sm:text-3xl font-bold mb-8 flex items-center text-blue-500 [text-shadow:_1px_1px_0_rgb(255_255_255_/_100%)]">
        ...
        <div className="container max-w-[600px]">
          ...
          <div>
            ...
            <p>
              <Link href="/log/2024/2-weeks-in-new-zealand">
                🔗 2 Weeks in New Zealand (2024/11/30)
              </Link>
            </p>
          </div>
          <div>
            ...
            <p>
              <Link href="/log/2023/esl-one-kuala-lumpur">
                🔗 ESL One Kuala Lumpur (2023/12/17)
              </Link>
            </p>
          </div>
        </div>
