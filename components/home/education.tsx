        ...
        <div className="flex flex-col sm:flex-row w-full items-start">
          ...
          <div className="flex flex-col sm:flex-row sm:gap-32 gap-8 w-full sm:w-auto">
            <div className="flex flex-col items-center sm:items-start">
              <Image unoptimized={true} width={200} height={200} src="/education/unikom.png" alt="Universitas Komputer Indonesia" className="w-28 h-28 mb-2"/>
            ...
            <div className="flex flex-col items-center sm:items-start">
              <Image unoptimized={true} width={200} height={200} src="/education/smkn4.png" alt="SMK Negeri 4 Bandung" className="w-28 h-28 mb-2"/>
