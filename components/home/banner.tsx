...
export default function Banner() {
  ...
  return (
    <section className="h-screen w-screen relative flex justify-center items-center">
      <Id className="fixed -z-10 opacity-20 w-[1000px]"/>

      <div>
        <h1 className="text-[190px] font-black leading-[160px] shadow tracking-wide">
        ...
        <div className="flex justify-center mt-14">
          <div className="relative w-8-h-8 flex justify-center items-center cursor-pointer motion-reduce:animate-bounce">
            <CircleIcon className="w-8 h-8 fixed stroke-1"/>
            <ArrowDownIcon className="w-4 h-4"/>
          </div>
        </div>

        <div className="absolute top-0 left-0 pl-10 pt-10">
          <p className="flex items-center"><EnvelopeClosedIcon className="w-4 h-4 mr-2"/> m.irfan.fakhri66@gmail.com</p>
          <p className="flex items-center"><Crosshair1Icon className="w-4 h-4 mr-2"/> Indonesia</p>
        </div>
      </div>
    </section>
  )
