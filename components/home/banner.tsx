...
export default function Banner() {
  ...
  return (
    <section className="overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 dark:from-slate-950 dark:via-slate-900 dark:to-purple-950">
      <LazySection className="relative flex justify-center items-center h-svh w-full">
        ...
        <div className="absolute top-1/2 -translate-y-1/2 pb-20 px-4 sm:px-8">
          ...
          <p className="text-xl sm:text-2xl lg:text-5xl text-center intro-y mt-6 lg:mt-0 leading-tight sm:leading-normal text-slate-600 dark:text-white">
